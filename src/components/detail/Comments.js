                ...
                <ScrollView style={{flex: 1}}>
                    <View style={{
                        ...
                        <View style={styles.source}>
                            <View
                                style={[styles.center, {width: 140, borderRightWidth: 1, borderRightColor: "#f1f1f1"}]}>
                            ...
                            <View style={[styles.center, {flex: 1}]}>
                                <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
                                    <Text
                                        style={{fontSize: px2dp(13), color: "#333", paddingVertical: 3}}>{"服务态度"}</Text>
                                ...
                                <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
                                    <Text
                                        style={{fontSize: px2dp(13), color: "#333", paddingVertical: 3}}>{"商品评分"}</Text>
                                    <View style={{height: 10, marginHorizontal: 10}}>
                                        <Image source={LocalImg.star2} style={{height: 10, width: 55}}/>
                                        <View style={{
                                            height: 10,
